    ...
    >
                ...
                >
                    ...
                    <div class="relative z-10 text-center space-y-8">
                        ...
                        >
                            @csrf
                            <div
                                class="group cursor-text text-left"
                        ...
                        >
                            ...
                            <p class="text-xs text-slate-500 leading-relaxed">
                                <span class="font-bold text-slate-700"
                                    >Tips:</span
                                >
                                Pastikan token ujian sudah benar (kombinasi
                                huruf dan angka). Sebutkan token Anda setelah
                                asisten selesai bicara.
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <script>
            ...
            function getPanduanUtama() {
                ...
                teks +=
                    "Atau sebutkan angka nol untuk kembali, satu untuk mengulang input token, dan dua untuk bergabung ke ujian. ";
                teks +=
                    "Katakan Ulang, jika Anda butuh mendengarkan panduan ini lagi.";
                return teks;
            }
            ...
            function navigasiKe(nomor) {
                ...
                if (nomor === 0) {
                    ...
                    tokenInput.value = "";
                    tokenInput.focus();
                    teks = "Silakan sebutkan ulang token ujian Anda.";
                } else if (nomor === 2) {
                    ...
                    if (code.length < 3) {
                        ...
                        teks = "Memproses token ujian. Masuk ke ruang ujian.";
                        bicara(teks, () => {
                    ...
                    rec.onresult = (event) => {
                        ...
                        if (isConfirming) {
                            if (
                                ...
                                rec.stop();
                                bicara(
                                    "Maaf, perintah tidak dikenali. Sebut dua untuk gabung, atau satu untuk mengulang input token.",
                                    () => {
                                        rec.start();
                                    },
                                );
