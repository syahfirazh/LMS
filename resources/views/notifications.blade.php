    ...
    <div
        class="bg-white p-8 rounded-[2.5rem] border-l-8
            {{ $notif->is_read ? 'border-slate-200 opacity-80' : 'border-blue-500' }}
            shadow-sm hover:shadow-lg transition-all flex flex-col md:flex-row items-start md:items-center gap-6 cursor-pointer group"
    >
        <div
