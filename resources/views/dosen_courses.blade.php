...
<body class="m-0 font-['Plus_Jakarta_Sans'] bg-slate-50 text-slate-800 antialiased h-screen flex overflow-hidden">
                    ...
                    <div class="p-8 flex-1 flex flex-col">
                        ...
                        <div class="mt-auto pt-6 border-t border-slate-100 flex items-center justify-between">
                            ...
                            <div class="flex items-center gap-1 sm:gap-2">
                                <button type="button" onclick="event.preventDefault(); openEditModal({{ json_encode($kelas) }})" class="p-2 rounded-lg text-slate-300 hover:bg-blue-50 hover:text-blue-500 transition-all cursor-pointer" title="Edit Kelas">
                ...
                <form action="{{ route('dosen.kelas.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                            <div>
                                <label class="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1 block flex items-center justify-between">
                                    Kode <span class="text-blue-500 font-bold lowercase bg-blue-50 px-1 rounded">Otomatis</span>
                                </label>
                                <input type="text" id="input_kode_kelas" name="kode_kelas" readonly tabindex="-1" class="w-full bg-slate-100 border border-slate-200 rounded-xl px-4 py-2 font-black text-slate-500 text-sm outline-none cursor-not-allowed tracking-widest" />
                            </div>
   ...
   <div id="modalEditKelas" class="fixed inset-0 z-[100] hidden">
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        <div>
                            ...
                            <input type="text" id="edit_kode" name="kode_kelas" required class="w-full bg-slate-100 border border-slate-200 rounded-xl px-4 py-2 font-bold text-slate-500 text-sm outline-none cursor-not-allowed tracking-widest" readonly />
                        </div>
                        <div>
                            <label class="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1 block">SKS</label>
    ...
    <script>
        ...
        // FUNGSI UNTUK GENERATE KODE KELAS OTOMATIS (A-Z, 0-9, 6 Karakter)
        ...
        function toggleModal(modalID, show) {
            ...
            if (show) {
                // Jika membuka Modal Buat Kelas, otomatis isi kode random
