    ...
    <body class="m-0 font-['Plus_Jakarta_Sans'] bg-[#f8fafc] min-h-full flex flex-col border-box overflow-x-hidden text-slate-800">
        ...
        <script>
            ...
            function getPanduanSuara() {
                ...
                teks += "Panduan Navigasi Menu: Sebutkan angka satu untuk Pembelajaran, dua untuk Presensi, tiga untuk tetap di Penugasan, empat untuk Anggota kelas. ";
                
                if (totalTugas > 0) {
                    teks += `Terdapat ${totalTugas} tugas. Berikut daftarnya: `;
                    tugasList.forEach(function(tugas) {
                        teks += `Sebutkan angka ${tugas.voiceId} untuk membuka tugas ${tugas.judul}. `;
                    });
                } else {
                    teks += "Saat ini belum ada tugas yang diberikan oleh dosen. ";
                }
                
                teks += "Sebutkan angka nol untuk kembali ke beranda kelas. Katakan Ulang, kapanpun Anda ingin mendengar panduan suara ini lagi.";
