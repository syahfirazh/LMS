    ...
    <header class="bg-white/90 backdrop-blur-2xl border-b border-slate-200/60 sticky top-0 z-40 px-4 md:px-8 py-4 shadow-sm w-full shrink-0">
        <div class="max-w-7xl mx-auto flex items-center justify-between relative">
            ...
            <div class="flex items-center relative z-10 w-auto justify-end">
                <button onclick="alert('Fitur Export Excel akan segera hadir!')" class="px-5 sm:px-6 py-2.5 sm:py-3 bg-emerald-600 text-white font-black rounded-xl text-[10px] sm:text-xs uppercase tracking-widest hover:bg-emerald-700 transition-all shadow-md shadow-emerald-200 flex items-center gap-2 transform active:scale-95">
