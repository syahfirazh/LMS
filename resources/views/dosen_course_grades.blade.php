    ...
    <main class="flex-1 max-w-7xl mx-auto p-4 md:p-8 w-full space-y-8 mb-20 relative">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-slate-200 pb-6" data-aos="fade-down">
            ...
            <div class="flex gap-3 w-full md:w-auto">
                ...
                <a href="{{ route('dosen.grades.export', $kelas->id) }}" class="flex-1 md:flex-none px-6 py-3.5 bg-emerald-600 text-white rounded-xl text-[11px] font-black uppercase tracking-widest hover:bg-emerald-700 transition-all shadow-lg shadow-emerald-200 flex items-center justify-center gap-2 transform active:scale-95">
